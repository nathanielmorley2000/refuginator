...
Each entry should show the number of pollen grains for the user's taxon of interest in a given locality for the corresponding time interval. Entries for which data are unavailable should be left blank; entries for which data are available but lack pollen from the user's taxon of interest should be marked as "0."
